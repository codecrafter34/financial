    ...
    <>
      ...
      {isMobile && (
        <button
          ...
          className="fixed top-4 left-4 z-40 p-2 rounded-lg bg-[var(--surface-2)] md:hidden"
        >
      ...
      {/* Sidebar */}
      <aside className={cn(
        'fixed left-0 top-0 h-full w-64 glass-card rounded-none border-r border-[var(--border)] flex flex-col z-40 transition-transform duration-200',
        ...
        <div className="p-4 border-t border-[var(--border)]">
          ...
          <button
            onClick={logout}
            className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-lg bg-[var(--surface-2)] text-[var(--text-secondary)] hover:text-[var(--danger)] hover:bg-red-500/10 transition-colors text-sm"
          >
